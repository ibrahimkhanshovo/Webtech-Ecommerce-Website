...
if (isset($_SESSION['name'])) {
 ...
 ?>     
    <legend align="center" style="font-size: 2.0em">Yonex Badminton Bat</legend>

              
                  <center> <img src="187.jpg"  width="300px" height="300px"></center>
              <center> <div class="col-2">
                <h1>Yonex Badminton Bat</h1>
