...
if (isset($_SESSION['name'])) {
 ...
 ?>       
  <br><br>  
      ...
      <a href="bg.php" class="contact-btn">Adidas Belgium Home Kit</a>
      <a href="bd.php" class="contact-btn"> Bangladesh Home Kit</a>
         <a href="abg.php" class="contact-btn"> Belgium Away Kit</a>
